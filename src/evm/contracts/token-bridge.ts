import { ITokenBridge_abi_60d245b0_json, BridgeStorage_abi_e64111c0_json, BridgeStorageV1_abi_164708e0_json } from '@gitmyabi/bane-labs--bridge-evm-contracts/contracts';
...
// Create a combined type that includes all properties from ITokenBridge and only non-conflicting properties from both BridgeStorage contracts
export type TokenBridge = ITokenBridge_abi_60d245b0_json &
